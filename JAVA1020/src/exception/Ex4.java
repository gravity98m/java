...
public class Ex4 {
	...
	public static void printScore(int score) throws Exception {
		 ...
		 * => 따라서, 원하는 시점에 특정 조건 발생 시 강제로 예외를 발생해야 함
		 */
		if(score < 0 || score > 100) {
//			System.out.println(score + "점 : 점수 입력 오류!");
			// throw 키워들 사용하여 해당 예외 클래스 객체 생성
...
//			Exception e = new Exception("점수 입력 오류 - " + score);
			...
			// throw 키워드 뒤에 예외 객체변수를 지정하여 해당 예외를 발생시킴
//			throw e;
			// => 예외가 발생하므로 예외 처리가 필요하고 throws 키워드를 통해 
			//    메서드를 호출한 곳으로 예외 처리를 위임
