...
//		arr = new int[5];
		...
		arr[2] = 30;
		arr[3] = 40;
//		arr[4] = 50; // 초기화 하지 않을 경우 4번 인덱스는 0으로 자동 초기화 됨
		...
		arr2[2] = true;
		// 0번, 1번 인덱스를 초기화하지 않을 경우 기본값 false로 자동 초기화
		...
		System.out.println("========================================");
		// double 타입 배열 5개를 저장하는 배열 arr4생성 후
		// 임의의 4개의 실수로 초기화 후 전체 데이터를 차례대로 출력
