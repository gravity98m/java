...
//		System.out.println("NormalMember.a : " + NormalMember.a );
		...
		StaticMember.a = 500;
//		StaticMember.b = 500; // 컴파일에러 발생! 클래스명만으로는 접근 불가!
		System.out.printf("s1.a : %d, s2.a : %d \n", s1.a, s2.a);
