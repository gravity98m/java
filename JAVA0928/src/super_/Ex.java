...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * < 래퍼런스 super >
		 * - 슈퍼클래스의 멤버에 접근하기 위한 키워드(=래퍼런스 변수)
		 * - 래퍼런스 this와 마찬가지로 서브클래스 인스턴스를 생성할 때 생성되며 이 때, 자동으로 생성되는 슈퍼클래스의 인스턴스 주소를 저장하는 변수
		...
		System.out.println("-----------------------------------------");
		// 래퍼런스 super를 통해 슈퍼클래스의 멤버에 접근한 메서드 호출
		c.watchParentTv();
...
class Child extends Parent{
	...
	public void watchParentTv() {
		// 현재 인스턴스 내에서 오버라이딩으로 인해 은닉된 슈퍼클래스의 멤버는 래퍼런스 super를 통해 접근하면 사용이 가능하다!
		// => 레퍼런스 this와 사용방법이 동일함
