...
class CarInfoWithConstant {
	...
	// 	  => 상수의 이름을 명확하게 지정함으로써 복잡한 데이터도 이름만으로 단순히 사용이 가능하게 된다!
	
	// 1. 제조사 정보를 문자열로 지정하는 상수 선언
