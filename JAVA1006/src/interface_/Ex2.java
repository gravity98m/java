...
// => 인터페이스끼리 상속은 inplements 가 아닌 extends 사용
...
//	// 번식() 메서드를 호출하게 되면 어느 객체의 번식() 메서드를 호출하는 지
//	// 분명하지 않기 때문에 자바에서는 다중상속을 금지되어 있음 
//}
