...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   => 내부에 추상메서드를 가지고 있을 경우 추상메서드가 호출되면 안되므로
		 *      인스턴스 생성을 못하게 차단함
		...
		// 추상클래스인 AbstractClass 인스턴스생성
		//AbstractClass as = new AbstractClass(); // 컴파일 에러 발생!
		// => 인스턴스 생성 불가!
...
abstract class AbstractClass {
	...
	String memeber; // 인스턴스 변수
	
}

// 추상클래스 AbstractClass 를 상속받는 서브 클래스 SubClass 정의
