...
//	}
	 ...
	 * c.cal('-', 100, 10, 20); // 100 - 10 - 10 = 70 출력
...
class PrintOverloading {
	...
	public void print(int data) {
		System.out.println("print(int) 호출됨!");
		System.out.println(data);
	}
	
	public void print(double data) {
		System.out.println("print(double) 호출됨!");
		System.out.println(data);
	}
	
	public void print(String data) {
		System.out.println("print(String) 호출됨!");
		System.out.println(data);
	}
}
