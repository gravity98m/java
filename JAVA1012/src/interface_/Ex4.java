...
//			objArr[i].charge();
	...
	public void hasRelationShip() {
		...
		Chargeable[] chargeableArr2 = {c,c2};
		...
		for(int i = 0; i < chargeableArr2.length; i++) {
			chargeableArr2[i].charge();
		}
...
// Object 클래스 외에 슈퍼클래스가 없는 NoteBookPc 와 SmartPhone의
