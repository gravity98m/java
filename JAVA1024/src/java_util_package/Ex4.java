...
//		int month = date.getMonth(); // => Month month 로 변경해야함
		...
		System.out.println(today.plusMonths(1).plusDays(15)); // 1달 보름 뒤 날짜 설정
		...
		// 1.compareTo()
		// => 현재 객체 날짜가 비교 대상 객체보다 이전이면 음수, 이후면 양수, 같으면 0 리턴함
