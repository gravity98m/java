...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   => 입력 노드 : 키보드, 마우스, 파일, 네트워크, 데이터 베이스 등
		 *   => 출력 노드 : 키보드, 마우스, 파일, 네트워크, 데이터 베이스 등
		 *   
		 ...
		 *  => FileInputStream, FileReader, BufferdInputStream, BufferdReader 등
		 *  
		 *  2. 출력 스트림
		 *  => 자바에서 데이터가 출력될 때 처리하는 스트림
		 *  => 예를들어 편집화면에서 사용자가 쓴 글을 파일에 저장할 때 사용
		 *  => FileOutputStream, FileWriter, BufferdOutputStream, BufferedWriter 등
		 *  
		 *  
		 ...
		 *   => 읽어온 데이터나 int형이므로 문자로 변환 등의 후속 작업 필요
		 * - 가장 저수준의 입력방법
		 * 
		 */
//		InputStream is = System.in;
		// => finally 블록에서도 사용하기 위해 try문 위쪽에 선언
...
//			System.out.println("입력 데이터 : " +n); // 읽어온 1Byte만큼의 데이터 출력
...
//		}
		...
		// ==================================================================================
		/*
		 * try ~ with resourses 구문을 사용하여 자원 반환(close())을 자동으로 수행
		 ...
		 * - try ~ with resources 구문을 try 문에서 
		 */
...
//		}
		...
		while(n != 1) {
			...
			System.out.println("입력 데이터 : " +n+", 문자로 변환 : " +(char)n ); // 읽어온 1Byte만큼의 데이터 출력
