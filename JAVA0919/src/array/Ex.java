...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * 3. 기본 데이터 타입과 참조 데이터타입 모두 배열로 사용가능
		 ...
		 * 7. 배열의 이름(변수명0을 사용하여 배열에 접근 가능(인덱스 필요)
		 * 8. 배열의 크기는 배열명.length속성을 통해 알아낼 수 있음.
		 * 
		 * < 배열의 선언 기본 문법 >
		 * 데이터타입[] 변수명;
		...
		// 학생 점구 5개(정수)를 저장할 배열(score) 선언 및 생성, 초기화
		// 1. 배열 선언 : 데이터타입[] 배열명;
//		int[] score; // int형 여러개를 저장할 배열 score 선언
...
//		score = new int[5];
		...
		// => 이 때, 배열은 자동으로 기본값으로 초기화되므로 0 출력됨
...
//		System.out.println(score[5]); // 실행 시 오류 발생!
		// Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: Index 5 out of bounds for length 5 at JAVA0919/array.Ex.main(Ex.java:89)
...
//		System.out.println(score[4]); // score 배열의 4번 인덱스 데이터 값 출력
		...
		for(int i=0; i < 5; i++) { // for(int = 0; i <= 4, i++) 동일
		...
		for(int i=0; i < score.length; i++) { // for(int = 0; i <= 4, i++) 동일
			// => 0 ~ 4 까지 1씩 증가하는 제어변수 i를 인덱스 번호로 활용 가능
		...
		int arr3, arr4[]; // arr3는 int, arr4는 int[] 타입 변수 선언됨
		// => 따라서, 자바에서 추천하는 문법(데이터 타입 뒤  [] 명시) 사용 권장
	}
